...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::postproduction::list_sermon_sessions,
            commands::postproduction::rename_sermon_session,
            commands::postproduction::append_sermon_transcript,
            commands::postproduction::append_sermon_scriptures,
            commands::postproduction::analyze_sermon_audio,
            commands::postproduction::trim_sermon_audio,
            commands::postproduction::cut_sermon_audio,
            commands::postproduction::delete_sermon_session,
            commands::postproduction::verify_cleanvoice_api_key,
            commands::postproduction::process_with_cleanvoice,
            commands::postproduction::generate_openai_sermon_summary,
            commands::postproduction::update_sermon_summary,
            commands::postproduction::save_sermon_summary_as_note,
